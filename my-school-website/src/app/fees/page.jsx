        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-600">
              A quick scan of a unique QR code linked to our account allows for instant transfers.
            </p>

            {/* Make image clickable */}
            <a
              href="upi://pay?pa=neevbachpanki@oksbi&pn=Your%20Name&cu=INR"
              target="_blank"
            ...
            >
              <img
                ...
                alt="QR Code"
                className="mt-4 w-40 h-40 object-contain border p-2 rounded-lg cursor-pointer hover:scale-105 transition"
              />
            </a>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition">
            ...
            <div className="mt-3 text-gray-700 font-medium text-left">
              ...
              <p>Bank: <span className="font-bold">Indian Bank</span></p>
            </div>
          </div>
        </div>
      </section>
